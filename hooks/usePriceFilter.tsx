...
export const usePriceFilter = () => {
  ...
  const handleChangePriceFrom = (event: React.ChangeEvent<HTMLInputElement>) =>
    onPriceChange(event.target.value, setPriceFrom)
  const handleChangePriceTo = (event: React.ChangeEvent<HTMLInputElement>) =>
    onPriceChange(event.target.value, setPriceTo)
